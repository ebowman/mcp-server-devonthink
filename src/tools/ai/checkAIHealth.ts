...
export const checkAIHealthTool = createDevonThinkTool({
  ...
  description: "Check if DEVONthink's AI services are available and working properly. Tests each configured AI engine to determine what's actually working vs just configured.",

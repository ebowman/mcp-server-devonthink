...
export const createSummaryDocumentTool = createDevonThinkTool({
  ...
  description: `Create a standardized summary document from multiple DEVONthink documents using AI. This creates an actual document in your DEVONthink database.

This tool is for creating formal summary documents that become part of your DEVONthink workflow. The AI will generate a structured summary and save it as a new document.

Use this when you want to:
- Create a summary document for your files
- Generate a formal report from multiple sources  
- Archive a summary for future reference
- Build documentation from existing documents

For flexible analysis or custom questions, use 'ask_ai_about_documents' instead.`,
